...
var registerSourceHandler = function (videojs) {
    ...
    function Html5Hlsjs(source, tech) {
        ...
        function _initHlsjs() {
            ...
            _hls.on(Hlsjs.Events.LEVEL_LOADED, function (event, data) { tech.trigger("hlslevelloaded",data); _duration = data.details.live ? Infinity : data.details.totalduration; });
